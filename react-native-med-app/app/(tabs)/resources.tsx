...
function AnimatedResourceCard({
  ...
  const getResourceColor = (type: ResourceType) => {
    switch (type) {
      case "google_drive":
        return {
          bg: isDark ? "rgba(52, 168, 83, 0.2)" : "rgba(52, 168, 83, 0.1)",
          accent: "#34A853",
        }; // Google Drive green
      case "telegram":
        return {
          bg: isDark ? "rgba(0, 136, 204, 0.2)" : "rgba(0, 136, 204, 0.1)",
          accent: "#0088CC",
        };
      case "youtube":
        return {
          bg: isDark ? "rgba(255, 0, 0, 0.15)" : "rgba(255, 0, 0, 0.08)",
          accent: "#FF0000",
        };
      case "pdf":
        return {
      ...
      default:
        return { bg: colors.backgroundSecondary, accent: colors.textSecondary };
    }
  };
...
function ResourcesSkeleton({
  ...
  return (
    <View
      style={{ flexDirection: "row", flexWrap: "wrap", marginHorizontal: -8 }}
    >
      {[1, 2, 3, 4, 5, 6].map((i) => (
