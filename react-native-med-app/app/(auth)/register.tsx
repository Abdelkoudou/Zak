      ...
      >
        ...
        >
          <View className="px-6 py-8">
            ...
            <View className="space-y-4">
              ...
              <View>
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => setShowSpeciality(!showSpeciality)}
                >
                  <Text className={speciality ? 'text-gray-900' : 'text-gray-400'}>
              ...
              <View>
                ...
                >
                  <Text className={yearOfStudy ? 'text-gray-900' : 'text-gray-400'}>
                    {yearOfStudy ? YEARS.find(y => y.value === yearOfStudy)?.label : 'Sélectionner une année'}
                  </Text>
                </TouchableOpacity>
                {showYear && (
                  <View className="bg-white border border-gray-200 rounded-xl mt-1">
              ...
              <View>
                ...
                <TouchableOpacity 
                  className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3"
                  onPress={() => setShowRegion(!showRegion)}
                >
                  <Text className={region ? 'text-gray-900' : 'text-gray-400'}>
                    {region || 'Sélectionner une wilaya'}
                  </Text>
                </TouchableOpacity>
                {showRegion && (
                  <View className="bg-white border border-gray-200 rounded-xl mt-1 max-h-48">
              ...
              <View>
                ...
                <TextInput
                  className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 uppercase"
                  placeholder="MCQ-XXXX-XXXX"
                  value={activationCode}
                  onChangeText={setActivationCode}
                  autoCapitalize="characters"
                />
                <Text className="text-gray-400 text-sm mt-1">
                  Entrez le code fourni avec votre abonnement
                </Text>
              </View>
            </View>
            ...
            {/* Register Button */}
            <TouchableOpacity 
              className={`py-4 rounded-xl mt-8 ${isLoading ? 'bg-primary-300' : 'bg-primary-500'}`}
            ...
            <View className="flex-row justify-center mt-4">
              ...
              <Link href="/(auth)/login" asChild>
                <TouchableOpacity>
                  <Text className="text-primary-500 font-semibold">Se connecter</Text>
                </TouchableOpacity>
              </Link>
            </View>
          </View>
