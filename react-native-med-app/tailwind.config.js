...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 40px -10px rgba(9, 178, 173, 0.4)',
        'glow-lg': '0 0 60px -15px rgba(9, 178, 173, 0.5)',
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'linear-gradient(135deg, #09B2AD 0%, #0d9488 50%, #0f766e 100%)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 20px rgba(9, 178, 173, 0.3)' },
          '50%': { boxShadow: '0 0 40px rgba(9, 178, 173, 0.5)' },
        },
        shimmer: {
