  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!["owner", "admin", "manager"].includes(userRecord.role)) {
        ...
        throw new Error(
          `Access denied. Role '${userRecord.role}' does not have admin privileges.`,
        );
      }
          ...
          >
            ...
            >
              <motion.div variants={itemVariants}>
                <label
                  htmlFor="email"
                  className="block text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] mb-3 px-1"
                >
                  📧 Adresse Email
                </label>
                <motion.input
            ...
            >
              <motion.button
                ...
                whileHover={{
                  scale: 1.02,
                  boxShadow: "0 20px 40px -10px rgba(9, 178, 173, 0.4)",
                }}
                whileTap={{ scale: 0.98 }}
