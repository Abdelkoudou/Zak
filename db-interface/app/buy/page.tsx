...
const FEATURES = [
  { icon: '📚', text: 'Accès à tous les QCMs de l\'année choisie', highlight: true },
  { icon: '📊', text: 'Accès pour les QCMs de tous les unités/modules (5 U.E.I + 2 modules)' },
  { icon: '📁', text: 'Des ressources importantes (Drive, Chaîne Telegram)' },
  { icon: '📈', text: 'Suivi de progression et statistiques' },
  { icon: '📱', text: 'Application mobile Android, Web App sur iOS et site web' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <header className="relative py-6 px-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link href="https://fmc-app-two.vercel.app" className="flex items-center group rounded-xl ">
            <Image src="/images/Header1.png" alt="FMC APP" width={180} height={48} className="h-12 w-auto object-contain " />
          </Link>
          <Link href="https://fmc-app-two.vercel.app" className="hidden sm:flex items-center gap-2 text-slate-400 hover:text-white transition-colors text-sm">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-2 mb-6 backdrop-blur-sm">
              ...
              <span className="text-emerald-400 text-sm font-medium">Paiement unique • Accès jusqu&apos;à la fin d&apos;année</span>
            </div>
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Préparez vos examens de médecine avec plus de <span className="text-white font-semibold">10 000 QCM</span> organisés par année, module et type d&apos;examen
            </p>
          </div>
            ...
            <div className="lg:col-span-3 space-y-6 order-2 lg:order-1">
                ...
                <div className="grid gap-3">
                  {FEATURES.map((feature, i) => (
                    ...
                    >
                      ...
                      <span className={`${feature.highlight ? 'text-emerald-300 font-medium' : 'text-slate-300'}`}>
                        {feature.text}
                      </span>
                    </div>
                  ))}
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-slate-800/40 backdrop-blur rounded-xl p-4 text-center border border-slate-700/30">
                  ...
                  <p className="text-xs text-slate-400">Paiement<br/>Sécurisé</p>
                </div>
                <div className="bg-slate-800/40 backdrop-blur rounded-xl p-4 text-center border border-slate-700/30">
                  <div className="text-2xl mb-1">⚡</div>
                  <p className="text-xs text-slate-400">Activation<br/>Instantanée</p>
                </div>
                <div className="bg-slate-800/40 backdrop-blur rounded-xl p-4 text-center border border-slate-700/30">
                  <div className="text-2xl mb-1">💬</div>
                  <p className="text-xs text-slate-400">Support<br/>Disponible</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/20">
                ...
                <div className="text-center mb-6 pb-6 border-b border-slate-100">
                  <div className="inline-block bg-emerald-50 rounded-full px-4 py-1.5 mb-3">
                    <span className="text-emerald-600 text-xs font-bold uppercase tracking-wider">Abonnement Annuel</span>
                  </div>
                  <div className="flex items-baseline justify-center gap-1">
                    <span className="text-5xl font-bold text-slate-900">1000</span>
                    <span className="text-xl text-slate-500 font-medium">DA</span>
                  </div>
                  <p className="text-slate-500 text-sm mt-1">Paiement unique • Accès jusqu&apos;à fin d&apos;année</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-slate-500 mt-1">Le code d&apos;activation sera affiché après le paiement</p>
                  </div>
                  ...
                  <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
                    <div className="flex justify-between items-center mb-2 text-sm">
                      ...
                      <span className="font-medium text-slate-900">1000 DA</span>
                    </div>
                  ...
                  <div className="flex items-center justify-center gap-3 pt-2">
                    ...
                    <span className="text-xs font-medium text-slate-500">CIB</span>
                    <span className="text-slate-300">•</span>
                    <span className="text-xs font-medium text-slate-500">EDAHABIA</span>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { q: 'Comment recevoir mon code d\'activation ?', a: 'Après le paiement, votre code s\'affichera immédiatement. Vous pourrez le copier et l\'utiliser pour créer votre compte.' },
                { q: 'Quels moyens de paiement sont acceptés ?', a: 'Nous acceptons les cartes CIB et EDAHABIA via la plateforme sécurisée Chargily Pay.' },
                { q: 'Sur combien d\'appareils puis-je utiliser mon compte ?', a: 'Vous pouvez utiliser votre compte sur 2 appareils maximum simultanément (Android, iOS Web App, ou site web).' },
                { q: 'Le contenu est-il mis à jour ?', a: 'Oui, nous ajoutons régulièrement de nouvelles questions et ressources tout au long de l\'année.' },
              ].map((faq, i) => (
                <div key={i} className="bg-slate-800/50 backdrop-blur rounded-2xl p-6 border border-slate-700/50 hover:border-slate-600/50 transition-colors">
      ...
      <footer className="relative border-t border-slate-800 py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-slate-500 text-sm">© 2026 FMC APP. Tous droits réservés.</p>
        </div>
      </footer>
    </div>
  );
